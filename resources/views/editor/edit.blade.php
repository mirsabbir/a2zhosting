    ...
    <div class="row" style="margin:20px;">
        <div class="col-md-8 mr-auto ml-auto">
            ...
            <form action="/posts/{{$post->slug}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Slug</label>
                    <input type="text" class="form-control" placeholder="Enter a unique slug (a-z,-,0-9)" name="slug" value="{{$post->slug}}" disabled>
                    @if ($errors->has('slug'))
                        <span class="alert-danger" >
                ...
                <div class="row ">
                    ...
                    <input type="submit" class="btn btn-primary" style="margin:0 auto;" value="Update" name="publish">
